...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_analytics_events_type_timestamp", "analytics_events", ["event_type", "timestamp"]
    )
    op.create_index(
        "ix_analytics_events_session_timestamp", "analytics_events", ["session_id", "timestamp"]
    )
    ...
    op.create_index(
        "ix_analytics_metrics_date_period", "analytics_metrics", ["metric_date", "period_type"]
    )
